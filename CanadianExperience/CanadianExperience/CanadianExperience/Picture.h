...
public:
    ...
    * \param size The new picture size */
    ...
    /** The machines in this picture
    * \returns Machines */
    std::vector<std::shared_ptr<CMachineDrawable>> GetMachines() { return mMachines; }

    /** Adds a machine to this picture
    * \param machine The machine to add */
    void AddMachine(std::shared_ptr<CMachineDrawable> machine) { mMachines.push_back(machine); }
...
private:
    ...
    /// The machines associated with this picture
    std::vector<std::shared_ptr<CMachineDrawable>> mMachines;
