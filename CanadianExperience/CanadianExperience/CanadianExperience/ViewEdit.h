...
public:
    ...
    afx_msg void OnMachineleftDialoguebox();
    afx_msg void OnMachinerightDialoguebox();
    afx_msg void OnStarttimeSetLeft();
    afx_msg void OnStarttimeRemoveLeft();
    afx_msg void OnStarttimeSetRight();
    afx_msg void OnStarttimeRemoveRight();
};
